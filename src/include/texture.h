...
enum class teTextureFormat { Invalid, BC1, BC1_SRGB, BC2, BC2_SRGB, BC3, BC3_SRGB, BC4U, BC4S, BC5U, BC5S, R32F, R32G32F, R32G32B32A32F, Depth32F, Depth32F_S8, BGRA_sRGB, RGBA_sRGB, BGRA };
