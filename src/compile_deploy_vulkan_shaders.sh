...
dxc -Ges -spirv -fspv-target-env=vulkan1.3 -E bloomThreshold -all-resources-bound -T ps_6_5 shaders/hlsl/bloom.hlsl -Fo ../build/shaders/bloom_threshold.spv
dxc -Ges -spirv -fspv-target-env=vulkan1.3 -E bloomBlur -all-resources-bound -T ps_6_5 shaders/hlsl/bloom.hlsl -Fo ../build/shaders/bloom_blur.spv
