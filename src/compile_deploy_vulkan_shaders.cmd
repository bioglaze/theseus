...
%VULKAN_SDK%/bin/dxc -Ges -spirv -fspv-target-env=vulkan1.3 -E fullscreenAdditivePS -all-resources-bound -T ps_6_5 shaders/hlsl/fullscreen.hlsl -Fo ../build/shaders/fullscreen_additive_ps.spv
