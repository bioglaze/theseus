...
clang++ -Iinclude samples/game/game.cpp samples/game/mainloop.cpp *.o ../build/engine.o -L/usr/local/lib -lvulkan -lwayland-client -lwayland-cursor -ldecor-0 -o ../build/game
