...
{
    return CreateBuffer( renderer.device, renderer.deviceMemoryProperties, size, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, BufferViewType::None, debugName );
}
